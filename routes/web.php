...
Route::get('/producto/{categoria}/{producto?}', [ProductosController::class, 'show'])->name('producto');
Route::get('/accesorios', [AccesorioController::class, 'index'])->name('accesorios');
Route::get('/accesorios/{producto}', [AccesorioController::class, 'show'])->name('accesorio');
