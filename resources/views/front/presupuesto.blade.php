                    ...
                    <div class="grid lg:grid-cols-2 gap-6 mb-6">
                        <div class="w-full relative">
                            ...
                            <select name="producto" id="producto" required
                                class="border border-[#DEDFE0] rounded-md w-full h-12 px-4 bg-white focus:border-main-color focus:outline-none transition-colors">
                        ...
                        <div class="w-full flex flex-col items-start justify-between gap-10 lg:mb-3">
                            <div class="w-full relative py-2">
                                ...
                                <div class="relative">
                                    ...
                                    <label for="archivo"
                                        class="flex items-center border border-[#DEDFE0] rounded-md w-full h-12 px-4 cursor-pointer">
