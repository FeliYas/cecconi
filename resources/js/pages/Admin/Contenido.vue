...
<template>
    <div class="group relative h-full">
        ...
        <hr class="border-t-[3px] border-main-color opacity-70 rounded">
                    ...
                    <div class="flex flex-col md:flex-row gap-8">
                        <div class="md:w-1/3 flex flex-col">
                            <h3
                                ...
                                Imagen principal</h3>
                            <div
                                class="relative overflow-hidden rounded-lg border-2 border-gray-200 group-hover:border-main-color transition-all duration-300 min-h-80">
                            ...
                            <span class="text-sm text-gray-400 mt-2 italic">Recomendación: 670x600 px</span>
