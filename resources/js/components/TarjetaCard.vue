...
<template>
  <div
    ...
    <div class="mb-4">
      <img v-if="tarjeta.icono" :src="tarjeta.icono" alt="icono" class="h-12 w-12 object-contain mx-auto" />
    ...
    <transition name="card-fade-scale" mode="out-in">
      <div v-if="editando" key="edit" class="w-full flex flex-col flex-1">
        ...
        <div class="flex gap-2 w-full mt-auto">
          <button @click="cancelarEdicion" class="btn-primary flex-1">Cancelar</button>
          <button @click="guardarCambios" class="btn-secondary flex-1">Guardar</button>
        </div>
      </div>
      <div v-else key="view" class="w-full flex flex-col flex-1 items-center">
        ...
        <div class="w-full flex justify-center mt-auto">
          <button @click="editando = true" class="btn-secondary w-30">
            Editar
          </button>
        </div>
      </div>
